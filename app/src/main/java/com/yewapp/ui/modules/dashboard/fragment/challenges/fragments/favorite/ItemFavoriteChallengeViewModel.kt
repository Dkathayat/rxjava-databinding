...
class ItemFavoriteChallengeViewModel(
...
//        isShow.set(flagActive)
        ...
        maxCalories.set("Calorie (${activeChallengeDetails.minimumCalories})")//assign when creating challenge
        maxDistance.set("Distance (${activeChallengeDetails.minimumMiles})")
        maxTime.set("Time (${activeChallengeDetails.totalTime})")
        elevation.set("Elev. Gain (${activeChallengeDetails.minimumElevationGain})")
